      ...
      <Col className="col-md-3 d-flex flex-column sidebar-wrap side-height h-100">
        ...
        <Accordion className="mt-md-5">
          <Accordion.Item eventKey="0" style={{ border: 'unset' }}>
            <Accordion.Header>
              <FiHome style={{ marginRight: '1vw', backgroundColor: '#456BF3', borderRadius: '2vw', width: '2vw', height: '2vw', padding: '5px', color: '#FFFFFF' }} /> Store
            </Accordion.Header>
            <Link to="/">
          ...
          <Accordion.Item eventKey="1" style={{ border: 'unset' }}>
            <Accordion.Header>
              <FiBox style={{ marginRight: '1vw', backgroundColor: '#F36F45', borderRadius: '2vw', width: '2vw', height: '2vw', padding: '5px', color: '#FFFFFF' }} />
              Product
            </Accordion.Header>
            <Link to="/">
          ...
          <Accordion.Item eventKey="2" style={{ border: 'unset' }}>
            <Accordion.Header>
              <FiShoppingCart style={{ marginRight: '1vw', backgroundColor: '#F3456F', borderRadius: '2vw', width: '2vw', height: '2vw', padding: '5px', color: '#FFFFFF' }} />
              Order
            </Accordion.Header>
            <Link to="/">
        ...
        <Button className="text-decoration-none text-muted ps-0 pt-0" variant="grey" onClick={onLogout}>
          <div className="d-flex flex-row gap-3 mt-3">
            <div className="icon-wrap-two text-center">
