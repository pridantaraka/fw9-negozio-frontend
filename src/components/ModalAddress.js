            ...
            <div className="d-flex flex-row gap-5">
              ...
              <div className="d-flex flex-column gap-2">
                <span className="text-muted">Recipient's telephone number</span>
                  <Form className="form-modal" noValidate onSubmit={handleSubmit}>
                    <Form.Group controlId="formatBasicName">
                      <Form.Control name="phonenumber" type="text" onChange={handleChange} isInvalid={!!errors.phonenumber}/>
              ...
              <div className="d-flex flex-row gap-5">
                <div className="d-flex flex-column gap-2">
                  <span className="text-muted">Address</span>
                    <Form className="form-modal" noValidate onSubmit={handleSubmit}>
                      <Form.Group controlId="formatBasicAddress">
                        <Form.Control name="fulladdress" type="text" onChange={handleChange} isInvalid={!!errors.fulladdress}/>
              ...
              <div className="d-flex flex-column gap-2">
                ...
                <Form className="form-modal" noValidate onSubmit={handleSubmit}>
                  <Form.Group controlId="formatBasicName">
                    <Form.Control name="postalcode" type="text" onChange={handleChange} isInvalid={!!errors.postalcode}/>
              ...
              <div className="d-flex flex-row gap-5">
                <div className="d-flex flex-column gap-2">
                  <span className="text-muted">City or Subdistrict</span>
                    <Form className="form-modal" noValidate onSubmit={handleSubmit}>
                      <Form.Group controlId="formatBasicAddress">
                        <Form.Control name="city" type="text" onChange={handleChange} isInvalid={!!errors.city}/>
    ...
    return (
      <>
        ...
        <Modal show={show} onHide={handleClose} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
            ...
            <label className="d-flex flex-row gap-2 text-muted ms-md-3">
              <input type="checkbox" value="primary" onChange={changeRadio}/> Make it the primary address
            </label>
