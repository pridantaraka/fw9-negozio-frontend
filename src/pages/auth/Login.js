  ...
  return (
    <>
      <Form noValidate onSubmit={handleSubmit} className="mt-5 gap-2">
        ...
        <div className="text-muted text-end my-5">
          <Link to="/resetpassword" className="link-dark text-decoration-none">
            Forgot Password?
          </Link>
        </div>
        <div>
          <Button className="btn btn-lg button-auth mx-auto w-50" type="submit">
            Confirm
          </Button>
        </div>
        <div className="text-center my-5">
          Don't have a Negozio account? Let's{" "}
          <Link to="/register" className="fw-bold text-decoration-none text">
            Register
          </Link>
        </div>
      </Form>
      ...
      <Container className="all-font">
        <Col className="m-4 p-5 text-center justify-content-center align-items-center">
          <div className="m-5 p-5">
            ...
            <div>
              <button
                className="btn btn-lg button-role customer text-center"
                value=""
              >
                Customer
              </button>
              <Link to="/loginseller" className="text-decoration-none">
                <button className="btn btn-lg button-role text-center">
                  Seller
                </button>
              </Link>
            </div>
